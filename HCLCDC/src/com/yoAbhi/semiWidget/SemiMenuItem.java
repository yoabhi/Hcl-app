...
public class SemiMenuItem {
	...
	private OnSemiMenuPressed mCallback;
	private int mIconDimen;
	
	public interface OnSemiMenuPressed {
	 ...
	 * @param mText
	 */
	public SemiMenuItem(String id, Drawable mIcon, String mText) {
		super();
		this.mMenuID = id;
		this.mIcon = mIcon;
		this.mText = mText;
		this.mMenuNormalColor = Color.WHITE;
		this.mMenuSelectedColor = Color.CYAN;
	 ...
	 */
	public void setOnSemiMenuPressed(OnSemiMenuPressed mCallback) {
	 ...
	 */
	public OnSemiMenuPressed getCallback() {
		return mCallback;
	}
